...
namespace JUEditor
{
    public static class CustomEditorStyles
    {
        ...
        {
            Font font = AssetDatabase.LoadAssetAtPath<Font>("Assets/JU Voxel/Editor/Resources/Fonts/Hyperjump Bold.otf");
            return font;
        }
    }
    public static class CustomEditorUtilities
    {
        ...
        public static void JU_AssetTitle(string TitleName = "")
        {
            ...
            if (logo == null)
            {
                logo = GetImage("Assets/JU Voxel/Textures/Icons/JU VOXEL Banner.png");
                return;
            }
            else
            {
